...
import com.example.firstapp.databinding.ActivityLevel30Binding;

public class Level30 extends AppCompatActivity {

    private ActivityLevel30Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel30Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 30));
