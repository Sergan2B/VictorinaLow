...
import com.example.firstapp.databinding.ActivityLevel11Binding;

public class Level11 extends AppCompatActivity {

    private ActivityLevel11Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel11Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 11));
