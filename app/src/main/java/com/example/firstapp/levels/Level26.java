...
import com.example.firstapp.databinding.ActivityLevel26Binding;

public class Level26 extends AppCompatActivity {

    private ActivityLevel26Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel26Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 26));
