...
import com.example.firstapp.databinding.ActivityLevel13Binding;

public class Level13 extends AppCompatActivity {

    private ActivityLevel13Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel13Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 13));
