...
import com.example.firstapp.databinding.ActivityLevel27Binding;

public class Level27 extends AppCompatActivity {

    private ActivityLevel27Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel27Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 27));
