...
import com.example.firstapp.databinding.ActivityLevel29Binding;

public class Level29 extends AppCompatActivity {

    private ActivityLevel29Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel29Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 29));
