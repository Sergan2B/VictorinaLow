...
import com.example.firstapp.databinding.ActivityLevel21Binding;

public class Level21 extends AppCompatActivity {

    private ActivityLevel21Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel21Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 21));
