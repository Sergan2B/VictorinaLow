...
import com.example.firstapp.databinding.ActivityLevel6Binding;

public class Level6 extends AppCompatActivity {

    private ActivityLevel6Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel6Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 6));
