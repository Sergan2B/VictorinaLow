...
import com.example.firstapp.databinding.ActivityLevel18Binding;

public class Level18 extends AppCompatActivity {

    private ActivityLevel18Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel18Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 18));
