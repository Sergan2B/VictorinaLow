...
import com.example.firstapp.databinding.ActivityLevel15Binding;

public class Level15 extends AppCompatActivity {

    private ActivityLevel15Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel15Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 15));
