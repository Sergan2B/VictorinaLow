...
import com.example.firstapp.databinding.ActivityLevel3Binding;

public class Level3 extends AppCompatActivity {

    private ActivityLevel3Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel3Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 3));
