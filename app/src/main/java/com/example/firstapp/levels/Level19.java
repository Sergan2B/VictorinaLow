...
import com.example.firstapp.databinding.ActivityLevel19Binding;

public class Level19 extends AppCompatActivity {

    private ActivityLevel19Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel19Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 19));
