...
import com.example.firstapp.databinding.ActivityLevel9Binding;

public class Level9 extends AppCompatActivity {

    private ActivityLevel9Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel9Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 9));
