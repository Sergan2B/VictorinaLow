...
import com.example.firstapp.databinding.ActivityLevel23Binding;

public class Level23 extends AppCompatActivity {

    private ActivityLevel23Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel23Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 23));
