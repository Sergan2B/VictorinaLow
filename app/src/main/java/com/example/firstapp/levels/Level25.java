...
import com.example.firstapp.databinding.ActivityLevel25Binding;

public class Level25 extends AppCompatActivity {

    private ActivityLevel25Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel25Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 25));
