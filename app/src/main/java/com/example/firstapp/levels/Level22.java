...
import com.example.firstapp.databinding.ActivityLevel22Binding;

public class Level22 extends AppCompatActivity {

    private ActivityLevel22Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel22Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 22));
