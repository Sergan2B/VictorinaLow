...
import com.example.firstapp.databinding.ActivityLevel17Binding;

public class Level17 extends AppCompatActivity {

    private ActivityLevel17Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel17Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 17));
