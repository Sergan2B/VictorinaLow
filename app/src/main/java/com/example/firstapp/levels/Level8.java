...
import com.example.firstapp.databinding.ActivityLevel8Binding;

public class Level8 extends AppCompatActivity {

    private ActivityLevel8Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel8Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 8));
