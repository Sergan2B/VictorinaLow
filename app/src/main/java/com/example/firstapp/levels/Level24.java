...
import com.example.firstapp.databinding.ActivityLevel24Binding;

public class Level24 extends AppCompatActivity {

    private ActivityLevel24Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel24Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 24));
