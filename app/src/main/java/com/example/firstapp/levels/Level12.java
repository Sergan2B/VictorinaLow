...
import com.example.firstapp.databinding.ActivityLevel12Binding;

public class Level12 extends AppCompatActivity {

    private ActivityLevel12Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel12Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 12));
