...
import com.example.firstapp.databinding.ActivityLevel7Binding;

public class Level7 extends AppCompatActivity {

    private ActivityLevel7Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel7Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 7));
