...
import com.example.firstapp.databinding.ActivityLevel5Binding;

public class Level5 extends AppCompatActivity {

    private ActivityLevel5Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel5Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 5));
