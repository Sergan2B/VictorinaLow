...
import com.example.firstapp.databinding.ActivityLevel28Binding;

public class Level28 extends AppCompatActivity {

    private ActivityLevel28Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLevel28Binding.inflate(getLayoutInflater());
    ...
    private void setCorrect() {
        binding.button.setOnClickListener(v -> {
            ...
            setResult(RESULT_OK, getIntent().putExtra("Ser", 28));
